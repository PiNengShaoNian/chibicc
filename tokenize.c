...
// Consumes the current token if it match 'op'
...
// Returns true if c is valid a non-first character of an identifier.
...
static int read_escaped_char(char **new_pos, char *p)
{
  ...
  *new_pos = p + 1;
  ...
  // of the compiler but also for the security of generated code.
...
// is mare relaxed than the definition of that at the later stages.
