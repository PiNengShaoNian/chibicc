...
// Read a UTF-8-encode Unicode code point from a source file.
// We assume that source files are always in UTF-8.
//
// UTF-8 is a variable-width encoding in which one code point
// is encoded in one to four bytes. One byte UTF-8 code points are
